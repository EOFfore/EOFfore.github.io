    ...
    <xsl:template match="/">
        ...
        <html>
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="../static/css/Example_lc.css"/>
            </head>
            <body>
                <div id="div_title">
                ...
                <xsl:for-each select="film/item">
                    <xsl:if test="information/name/text()='西虹市首富'">


                        <div>
                            <img align="left" width="494" height="790" style="margin-left:100px;">
                                <xsl:attribute name="src">
                                    <xsl:value-of select="information/poster"/>
                                </xsl:attribute>
                            </img>
                            <div style="color:#0C6978; margin-left:668px;font-size:26px;">
                                <br/>
                                <!--<div style="text-align:center">
                            <strong style="font-size:48px;color:#000000">电影基本信息</strong></div>-->

                                <div style="font-weight:bold;font-size:40px;color:#483D8B;margin-top:0;display:inline;">
